<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="card">
            <form class="form-horizontal" action="<?=base_url("ifaccount/cPassword_validation")?>" method="post">
                <div class="card-body">
        ...
        <div class="card">
            <form class="form-horizontal" action="<?=base_url("ifaccount/uploadRes_validation")?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
        ...
        <div class="card">
            <form class="form-horizontal" action="<?=base_url("ifaccount/uploadCur_validation")?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
        ...
        <div class="card">
            <form class="form-horizontal" action="<?=base_url("ifaccount/uploadCer_validation")?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
        ...
        <div class="card">
            <form class="form-horizontal" action="<?=base_url("ifaccount/uploadQua_validation")?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
        ...
        <div class="card">
            <form class="form-horizontal" action="<?=base_url("ifaccount/uploadPic_validation")?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
        ...
        <div class="card">
            <form class="form-horizontal" action="<?=base_url("ifaccount/uploadAdd_validation")?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <form class="form-horizontal" action="<?=base_url("ifaccount/cUinformation_validation")?>" method="post">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="c_id" id="c_id" placeholder="">
                                <option value="<?php if($row->c_id!=NULL){echo $row->c_id;}else{echo "100";} ?>"><?php echo $row->c_id; ?>- Country -</option>
                                <?php foreach($result4 as $row2) {?>
