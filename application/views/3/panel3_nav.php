            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url("thaccount/profile")?>" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu"><?=$this->lang->line('panel14');?></span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu"><?=$this->lang->line('panel15');?></span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="<?=base_url("thjobv/udata")?>" class="sidebar-link"><i class="mdi mdi-contact-mail"></i><span class="hide-menu"> <?=$this->lang->line('panel20thif');?> </span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url("thjobv/ufile")?>" class="sidebar-link"><i class="mdi mdi-folder"></i><span class="hide-menu"> <?=$this->lang->line('panel21thif');?> </span></a></li>
                            </ul>
                        </li>
