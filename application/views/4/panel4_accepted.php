<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"><?=$this->lang->line('panel61fo');?></h5>
                <div class="table-responsive">
                    ...
                    <form name="bulk_action_form" action="" method="post" onSubmit="return action_confirm();"/>
                        ...
                        <input type="submit" class="btn btn-success"    name="bulk_action_submit1" value="<?=$this->lang->line('panel86fo');?>"/>
                        <input type="submit" class="btn btn-danger"     name="bulk_action_submit2" value="<?=$this->lang->line('panel87fo');?>"/>
                        <input type="submit" class="btn btn-warning"    name="bulk_action_submit4" value="<?=$this->lang->line('panel88fo');?>"/>
                    </form>
                </div>
            </div>
        </div>
