<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"><?=$this->lang->line('panel59fo');?></h5>
                <div class="table-responsive">
                    ...
                    <form name="bulk_action_form" action="" method="post" onSubmit="return action_confirm();"/>
                        ...
                        <input type="submit" class="btn btn-success"    name="bulk_action_submit1" value="<?=$this->lang->line('panel81fo');?>"/>
                        <input type="submit" class="btn btn-danger"     name="bulk_action_submit2" value="<?=$this->lang->line('panel82fo');?>"/>
                    </form>
                </div>
            </div>
        </div>
